...
export const FlaskConical = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M10 2v7.31" /><path d="M14 9.31V2" /><path d="M4 14h16" /><path d="M10 20.31V14" /><path d="M14 14v6.31" /><path d="M8 22h8" /><path d="M7 14a5 5 0 0 0-5-5" /><path d="M17 9a5 5 0 0 1 5-5" />
    </svg>
);
...
export const Gem = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M6 3h12l4 6-10 13L2 9z" /><path d="M12 22V9" /><path d="m3.29 9 8.71 13 8.71-13" />
    </svg>
);
...
export const Sparkles = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M9.9 2.1 7.5 7.5l-5.4 2.4 5.4 2.4 2.4 5.4 2.4-5.4 5.4-2.4-5.4-2.4Z" />
        <path d="M21 12.6 18.6 7.2l-5.4-2.4 5.4-2.4 2.4-5.4 2.4 5.4 5.4 2.4-5.4 2.4Z"/>
        <path d="M12.6 21 10.2 15.6l-5.4-2.4 5.4-2.4 2.4-5.4 2.4 5.4 5.4 2.4-5.4 2.4Z" />
    </svg>
);
